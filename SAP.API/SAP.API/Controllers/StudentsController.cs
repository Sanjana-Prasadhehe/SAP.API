...
namespace SAP.API.Controllers
{
    ...
    public class StudentsController : Controller
    {
        ...
        [HttpDelete]
        [Route("[controller]/{studentId:guid}")]
        public async System.Threading.Tasks.Task<IActionResult> DeleteStudentAsync([FromRoute] Guid studentId)
        {
            if (await studentRepository.Exists(studentId))
            {
        ...
        public async System.Threading.Tasks.Task<IActionResult> UploadImage([FromRoute] Guid studentId, IFormFile profileImage)
        {
