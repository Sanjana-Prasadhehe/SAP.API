...
namespace SAP.API.Repositories
{
    public class SqlStudentRepository : IStudentRepository
    {
        ...
        public async System.Threading.Tasks.Task<List<Gender>> GetGendersAsync()
        {
        ...
        public async System.Threading.Tasks.Task<Student> UpdateStudent(Guid studentId, Student request)
        {
        ...
        public async System.Threading.Tasks.Task<Student> DeleteStudent(Guid studentId)
        {
        ...
        public async System.Threading.Tasks.Task<Student> AddStudent(Student request)
        {
        ...
        public async System.Threading.Tasks.Task<bool> UpdateProfileImage(Guid studentId, string profileImageUrl)
        {
            var student = await GetStudentAsync(studentId);
